...
# Використала SVC з параметром poly
classifier = SVC(kernel='poly', degree=8, random_state=0, max_iter=5000)
classifier.fit(X_train, y_train)
# Розрахувала результати (аналогічно до попереднього завдання)
